...
function myResultIn() {
    ...
    document.getElementById('pickup_result_in').innerHTML = pick_area_in;
    document.getElementById('deliver_result_in').innerHTML = deliver_area_in;
...
function myResultOut(){
    ...
    if (weight_out <= 1) {
        document.getElementById('total_ammount_out').innerHTML = parseInt(price_near) + 155;
        ...
        document.getElementById('total_ammount_out').innerHTML = parseInt(price_near) + 175;
        document.getElementById('deliver_charge_out').innerHTML = 'Tk. 175';
        document.getElementById('cod_charge_out').innerHTML = 'Discounted';
    }
    else if (weight_out <= 3) {
        document.getElementById('total_ammount_near').innerHTML = parseInt(price_near) + 205;
